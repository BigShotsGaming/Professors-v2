module.exports.run = (client, message, args) => { // eslint-disable-line no-unused-vars
  message.delete();
    ...
    if (message.channel.type === `dm`) {
      ...
      var region;
      if (message.guild.region === `us-east`) {region = `:flag_us: Eastern USA`;}
      else if (message.guild.region === `brazil`) {region = `:flag_br: Brazil`;}
      else if (message.guild.region === `eu-central`) {region = `:flag_eu: Central Europe`;}
      else if (message.guild.region === `hongkong`) {region = `:flag_cn: Hong Kong`;}
      else if (message.guild.region === `japan`) {region = `:flag_jp: Japan`;}
      ...
      else if (message.guild.region === `us-central`) {region = `:flag_us Central USA`;}
